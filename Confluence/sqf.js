/*
	Language: SQF
	Author: Pieter De Stickere <pieterdestickere@gmail.com>
	Contributors: Marvin Saignat <contact@zgmrvn.com>, Dedmen Miller <dedmen@dedmen.de>, Niels De Stickere
...
SyntaxHighlighter.brushes.Custom = function()
{
	...
	var functions = 'abs accTime acos action actionIDs actionKeys actionKeysImages actionKeysNames ' +
  ...
  'weapons weaponsItems weaponsItemsCargo weaponState weaponsTurret weightRTD WFSideText wind ';
	...
	var constants = 'blufor civilian configNull controlNull displayNull east endl false grpNull independent lineBreak ' +
  ...
  'sideUnknown taskNull teamMemberNull true west';
	...
	var keywords = 'case catch default do else exit exitWith for forEach from if ' +
  'private switch then throw to try waitUntil while with';

  this.regexList = [
		{ regex: /#\s*[a-z].*/gmi, css: 'color1'}, // includes
		{ regex: /\d/gmi, css: 'color1'}, // digits
		{ regex: /\d+/gmi, css: 'color1'}, // Natural numbers
		{ regex: /\d+\.\d+/gmi, css: 'color1'}, // floating point
		{ regex: /\b_+[a-zA-Z_]\w*/gmi, css: 'variable'}, // a variable starts with _
		{ regex: /[a-zA-Z][a-zA-Z0-9]+_fnc_\w*/gmi, css: 'functions'}, // a function should fit myTag_fnc_myFunction pattern
		...
		{ regex: new RegExp(this.getKeywords(functions), 'gmi'),	css: 'constants' }		// functions, named constants to adapt discord-style
  ];
};

SyntaxHighlighter.brushes.Custom.prototype  = new SyntaxHighlighter.Highlighter();
SyntaxHighlighter.brushes.Custom.aliases    = ['sqf'];
